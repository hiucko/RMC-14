...
ent-RMCArmorM4PMCBulletProof = M4 pattern PMC bulletproof armor
    .desc = A modification of the standard M3 armor. Designed for high-profile security operators and corporate mercenaries in mind. This set is designed for protecting against ballistics, and has minimal protection against blades and biohazards.
